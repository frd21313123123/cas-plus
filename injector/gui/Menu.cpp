...
void Menu::setupMenuStyle(bool isDarkTheme, float alpha)
{
	...
	const ImVec4 accent = ImVec4(0.56f, 0.36f, 0.97f, 1.0f);
	const ImVec4 accentHover = ImVec4(0.67f, 0.46f, 1.00f, 1.0f);

	style.Colors[ImGuiCol_Text] = ImVec4(0.90f, 0.91f, 0.96f, 1.0f);
	style.Colors[ImGuiCol_TextDisabled] = ImVec4(0.42f, 0.45f, 0.55f, 1.0f);
	style.Colors[ImGuiCol_WindowBg] = ImVec4(0.043f, 0.047f, 0.063f, 1.0f);
	style.Colors[ImGuiCol_ChildBg] = ImVec4(0.055f, 0.063f, 0.102f, 1.0f);
	style.Colors[ImGuiCol_PopupBg] = ImVec4(0.055f, 0.063f, 0.102f, 1.0f);
	style.Colors[ImGuiCol_Border] = ImVec4(0.106f, 0.118f, 0.188f, 1.0f);
	style.Colors[ImGuiCol_FrameBg] = ImVec4(0.071f, 0.078f, 0.133f, 1.0f);
	style.Colors[ImGuiCol_FrameBgHovered] = ImVec4(0.10f, 0.11f, 0.18f, 1.0f);
	style.Colors[ImGuiCol_FrameBgActive] = ImVec4(0.14f, 0.15f, 0.24f, 1.0f);
	style.Colors[ImGuiCol_CheckMark] = accentHover;
	style.Colors[ImGuiCol_SliderGrab] = accent;
	style.Colors[ImGuiCol_SliderGrabActive] = accentHover;
	style.Colors[ImGuiCol_Button] = ImVec4(0.071f, 0.078f, 0.133f, 1.0f);
	style.Colors[ImGuiCol_ButtonHovered] = ImVec4(0.12f, 0.13f, 0.22f, 1.0f);
